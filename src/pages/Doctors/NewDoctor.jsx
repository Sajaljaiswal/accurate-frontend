...
import { Save, UserPlus, MapPin, Building2, Phone, Mail, GraduationCap, Calendar, Lock } from 'lucide-react';
          ...
          <form className="p-6 md:p-10 space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-bold text-blue-900 uppercase border-b border-slate-100 pb-2">Professional Information</h3>
                ...
                <div className="flex gap-2">
                  ...
                  <div className="w-2/3">
                    ...
                    <input type="text" placeholder="Enter full name" className="w-full border border-slate-300 rounded-lg p-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="flex gap-1">
                      <select className="flex-grow border border-slate-300 rounded-lg p-2.5 text-sm">
                        <option>Select Degree</option>
                        <option>MBBS</option>
                        <option>MD</option>
                      </select>
                      <button type="button" className="bg-slate-100 p-2 rounded-lg hover:bg-slate-200 text-blue-600">+</button>
                    </div>
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea rows="2" className="w-full border border-slate-300 rounded-lg p-2.5 text-sm"></textarea>
                </div>
              </div>

              {/* Section 2: Contact & Personal Info */}
              <div className="space-y-4">
                <h3 className="text-sm font-bold text-blue-900 uppercase border-b border-slate-100 pb-2">Contact & Personal</h3>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-slate-500 mb-1">Phone (Clinic)</label>
                    <input type="text" className="w-full border border-slate-300 rounded-lg p-2.5 text-sm" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input type="email" placeholder="doctor@example.com" className="w-full border border-slate-300 rounded-lg p-2.5 text-sm" />
                </div>

                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold text-slate-500 mb-1">Date of Birth</label>
                    <input type="date" className="w-full border border-slate-300 rounded-lg p-2.5 text-sm text-slate-600" />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-slate-500 mb-1">Marriage Anniversary</label>
                    <input type="date" className="w-full border border-slate-300 rounded-lg p-2.5 text-sm text-slate-600" />
                  </div>
                </div>

                <div>
                  <label className="block text-xs font-semibold text-slate-500 mb-1">Portal Password</label>
                  <div className="relative">
                    <Lock className="absolute right-3 top-2.5 text-slate-400" size={16} />
                    <input type="password" placeholder="Create password" className="w-full border border-slate-300 rounded-lg p-2.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none" />
                  </div>
                </div>
                ...
                <div className="flex items-center gap-6 pt-2">
                  ...
                  <div className="flex gap-4">
                    <label className="flex items-center gap-2 text-sm cursor-pointer">
                      <input type="radio" name="status" className="w-4 h-4 text-blue-600" /> Tagged
                    </label>
                    <label className="flex items-center gap-2 text-sm cursor-pointer">
                      <input type="radio" name="status" className="w-4 h-4 text-blue-600" defaultChecked /> UnTagged
                    </label>
                  </div>
                </div>
              </div>
